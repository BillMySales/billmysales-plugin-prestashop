 ...
 * @version 2016-01-30
 */
class BillmysalesProductModuleFrontController extends ModuleFrontController
{

    /**
     * Acción que permite obtener los datos de un item (producto) para poder
     * consumir desde la aplicación web de BillMySales
     * @author Esteban De La Fuente Rubio, DeLaF (esteban[at]sasco.cl)
     * @version 2020-05-27
     */
    public function init()
    {
        ...
        // crear datos del item
            ...
            $item = [
                'TpoCodigo' => 'INT1',
                'VlrCodigo' => Tools::substr(Tools::getValue('product_id'), 0, 35),
                'NmbItem' => Tools::substr($this->product->name, 0, 80),
                'DscItem' => Tools::substr($this->product->meta_description, 0, 1000),
                'IndExe' => $this->product->tax_rate ? 0 : 1,
                'UnmdItem' => Tools::substr('', 0, 4),
